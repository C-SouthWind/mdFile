...
jdbc.url=jdbc:mysql://115.159.191.57:3306/zln?useSSL=true&useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8
jdbc.username=root
jdbc.password=chj0526
```
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!--扫描service下面的包-->
    <!--<context:component-scan base-package="com.chj.service"/>-->
    ...
    <!--AOP事务支持-->
    <aop:config>
        <aop:pointcut id="txPointCut" expression="execution(* com.chj.mapper.*.*(..))"/>
